            ...
            if (member instanceof GuildMember) {
                ...
                if (voiceChannel) {
                    if (!voiceChannel.permissionsFor(guild.me).has(voicePerms)) {
                        return InteractionUtils.replyOrFollowUp(arg, `AvBot doesn't have permissions to connect and/or to speak in your voice channel. Please enable "${voicePerms.join(", ")}" under channel permissions for AvBot.`);
                    }
